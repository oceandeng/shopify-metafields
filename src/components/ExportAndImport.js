...
class ExportAndImport extends React.Component {
    constructor(props) {
        ...
        this.exportOwnerResource = window.publicTools.getQuery(
            "exportOwnerResource"
        );
                        ...
                        this.setState(
                            ...
                            () => {
                                this.props.history.push(
                                    "/shopify-metafields/activity-logs"
                                );
                            }
                        );
                    } else {
        ...
        return (
            <>
                ...
                {activeImport ? (
                    <ImportModal
                        active={activeImport}
                        exportOwnerResource={this.exportOwnerResource}
                        onClose={(state) => {
                            this.handleCloseModal(state, "activeImport");
                        }}
                    />
                ) : (
                    ""
